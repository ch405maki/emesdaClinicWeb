    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <TextInput id="age" type="number" class="mt-1 block w-full border" v-model="form.age" required />
                <InputError class="mt-2" :message="form.errors.age" />
            </div>

            <div class="mt-4">
                <InputLabel for="sex" value="Sex" />
                <select id="sex" v-model="form.sex" class="mt-1 block w-full border rounded" required>
            ...
            <div class="mt-4">
                ...
                <select id="civil_status" v-model="form.civil_status" class="mt-1 block w-full border rounded" required>
            ...
            <div class="mt-4">
                <InputLabel for="contact" value="Number" /><span class="text-xs text-gray-800">Follow this Format: </span><span class="text-xs text-red-500 italic">09876543210</span>
            ...
            <div class="mt-4">
                ...
                <TextInput id="address" type="text" class="mt-1 block w-full border" v-model="form.address" />
                <InputError class="mt-2" :message="form.errors.address" />
            </div>

            <div class="mt-4">
                <InputLabel for="occupation" value="Occupation" />
                <TextInput id="occupation" type="text" class="mt-1 block w-full border" v-model="form.occupation" required />
                <InputError class="mt-2" :message="form.errors.occupation" />
            </div>

            <div class="mt-4">
                <InputLabel for="officeAddress" value="Office Address" />
                <TextInput id="officeAddress" type="text" class="mt-1 block w-full border" v-model="form.officeAddress" required />
                <InputError class="mt-2" :message="form.errors.officeAddress" />
            </div>

            <div class="mt-4">
                <InputLabel for="telNumber" value="Tel. Number" />
                <TextInput id="telNumber" type="text" class="mt-1 block w-full border" v-model="form.telNumber" required />
