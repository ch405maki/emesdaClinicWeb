<template>
    ...
    <div class="relative bg-cover bg-center bg-no-repeat before:absolute before:inset-0 before:backdrop-blur-[50px] before:bg-gradient-to-b before:from-transparent before:to-white" style="background-image: url('/images/gradientbg2.png');">    <div class="mx-auto max-w-screen-xl px-6 lg:px-8 relative">
        ...
        <div class="flex-shrink-0 flex px-2 py-3 items-center space-x-8 flex-1 justify-end justify-self-end ">
            <a class="text-gray-700 hover:text-lime-700 text-sm font-medium" href="login">Login</a>
...
<!-- Hero Section -->
    <div class="max-w-7xl mx-auto relative mt-16">
        <div class="relative py-16 flex justify-center px-4 sm:px-0">
            <div class="text-center">
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200">
                ...
                <div class="mt-5 sm:mt-8 sm:flex sm:justify-center">
                    <div class="rounded-md shadow">
                        <a class="flex w-full items-center justify-center rounded-md border border-transparent bg-blue-600 px-8 py-3 text-base font-medium text-white hover:bg-blue-700 md:py-4 md:px-10 md:text-lg" href="#">
...
<div class="text-center my-10">
    ...
    <span class="block text-sm text-center text-gray-500 px-8">© 2021-2022 Landwind™. All Rights Reserved.
		Built with 
