...
import { VApp, VContainer, VBtn, VIcon } from 'vuetify/components';
import 'vuetify/styles'; // Ensure you are using vuetify styles
            ...
            <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
                <div class="relative flex flex-col md:flex-row">
                    ...
                    <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
                        <a href="#_" class="font-medium leading-6 text-gray-600 hover:text-gray-900">Dental Record Management System</a>
                    </nav>
                </div>
                ...
                <div class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
                    ...
                    <a href="register" class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-green-600 border border-transparent rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
                        Sign up
                    </a>
                </div>
            </div>
        ...
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            <div class="w-full md:w-1/2 md:px-3">
                ...
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                    <span class="block xl:inline">Dental Record Management System</span>
...
@keyframes smooth-bounce {
  ...
  60% {
    transform: translateY(3%);
    animation-timing-function: cubic-bezier(0.4, 0.8, 0.4, 1); /* Slower downward movement */
  }
}
