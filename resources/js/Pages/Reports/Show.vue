  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex justify-between items-center">
        ...
        <button v-if="userRole !== 'student'" @click="exportPdf" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded flex items-center space-x-2">
    ...
    <div id="pdf-content" class="py-6 px-6">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- PDF template content -->
          <div id="pdf-template" hidden>
              <div class="pdf-header flex items-center justify-center">
                  <img src="/images/logo.png" alt="Kalinga State University Logo" class="logo w-8 h-8 mr-2">
                  <div>
                      <h1 class="text-3xl font-bold">Kalinga State University</h1>
